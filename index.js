...
console.log(createMenuItem('soup', 6, 'dinner'));
...
export const burger = {
  ...
  discount: function(string) {
    ...
    if (string === "teacher" || string === "student") {
      total = burger.price * .75;
      return total;
    } else if (string === "public") {
      total = burger.price * .9;
      return total;
    }
  }
}
...
*/
reviews.push({name: "D'Artagnan", rating: 4.5, feedback: "The burger was absolutely phenomenal and nothing else ever has come close in my life."})
console.log(reviews);
